...
# 
# Based on a notebook by John Salvatier, Thomas V. Wiecki, Christopher Fonnesbeck from [https://docs.pymc.io/en/stable/pymc-examples/examples/getting_started.html].

# ## Overview of `PyMC3`
# 
# From [https://docs.pymc.io/en/stable/about.html]:
