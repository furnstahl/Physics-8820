...
::::{admontion} **Claim:** we can do the tossing sequentially or all at once and get the same result. When is this true?
:::{admonition} Answer
:class: dropdown
...
<img src="/images/radioactive_lighthouse_problem_figure.png" alt="radioactive lighthouse figure" class="bg-primary mb-1" width="300px">
